<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHomePage.aspx.cs" Inherits="PetFinder.UserHomePage" Title="PetFinder User HomePage" MetaDescription="User HomePage" MetaKeywords="Pet, Finder, User, HomePage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>PetFinder User HomePage</title>
    <meta charset="utf-8" />
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <asp:Label ID="lblUserTag" runat="server" Text="(User)" CssClass="navbar-brand"></asp:Label>
                </div>
                <div class="collapse navbar-collapse" id="myNavbar">

                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="UserHomePage.aspx"><span class="glyphicon glyphicon-queen"></span> User Homepage</a></li>
                        ...
                        <li><a href="UserUpdate.aspx"><span class="glyphicon glyphicon-info-sign"></span> Update My Informations</a></li>
                    </ul>
                </div>
            </div>
        </nav>
